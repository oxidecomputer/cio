...
pub fn cmd_tables_run(cli_matches: &ArgMatches) {
    ...
    let dir = cli_matches.value_of("dir").unwrap_or(curdir_str);
...
static TEMPLATE_GROUPS: &str = "<!-- THIS WHOLE FILE IS GENERATED FROM THE CONFIGS REPO in src/tables.rs DO NOT EDIT IT DIRECTLY -->
# Groups
...
static TEMPLATE_LINKS: &str = "<!-- THIS WHOLE FILE IS GENERATED FROM THE CONFIGS REPO in src/tables.rs DO NOT EDIT IT DIRECTLY -->
# Links
...
static TEMPLATE_PEOPLE: &str = "<!-- THIS WHOLE FILE IS GENERATED FROM THE CONFIGS REPO in src/tables.rs DO NOT EDIT IT DIRECTLY -->
# People
