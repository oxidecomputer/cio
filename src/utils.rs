...
pub fn get_gsuite_token() -> Token {
    ...
    let gsuite_secret = service_account_key_from_file(&gsuite_credential_file.to_string()).unwrap();
...
pub static TEMPLATE_WARNING: &'static str = "# THIS FILE HAS BEEN GENERATED BY THE CONFIGS REPO
