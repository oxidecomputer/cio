...
impl NewRepo {
    pub fn new_from_full(r: octorust::types::FullRepository, cio_company_id: i32) -> Self {
        NewRepo {
            ...
            archive_url: r.archive_url.into(),
            assignees_url: r.assignees_url.into(),
            blobs_url: r.blobs_url.into(),
            branches_url: r.branches_url.into(),
            clone_url: r.clone_url.into(),
            collaborators_url: r.collaborators_url.into(),
            comments_url: r.comments_url.into(),
            commits_url: r.commits_url.into(),
            compare_url: r.compare_url.into(),
            contents_url: r.contents_url.into(),
            contributors_url: r.contributors_url.into(),
            deployments_url: r.deployments_url.into(),
            downloads_url: r.downloads_url.into(),
            events_url: r.events_url.into(),
            forks_url: r.forks_url.into(),
            git_commits_url: r.git_commits_url.into(),
            git_refs_url: r.git_refs_url.into(),
            git_tags_url: r.git_tags_url.into(),
            git_url: r.git_url.into(),
            hooks_url: r.hooks_url.into(),
            issue_comment_url: r.issue_comment_url.into(),
            issue_events_url: r.issue_events_url.into(),
            issues_url: r.issues_url.into(),
            keys_url: r.keys_url.into(),
            labels_url: r.labels_url.into(),
            languages_url: r.languages_url.into(),
            merges_url: r.merges_url.into(),
            milestones_url: r.milestones_url.into(),
            mirror_url: r.mirror_url.into(),
            notifications_url: r.notifications_url.into(),
            pulls_url: r.pulls_url.into(),
            releases_url: r.releases_url.into(),
            ssh_url: r.ssh_url.into(),
            stargazers_url: r.stargazers_url.into(),
            statuses_url: r.statuses_url.into(),
            subscribers_url: r.subscribers_url.into(),
            subscription_url: r.subscription_url.into(),
            svn_url: r.svn_url.into(),
            tags_url: r.tags_url.into(),
            teams_url: r.teams_url.into(),
            trees_url: r.trees_url.into(),
            homepage: r.homepage,
            language: r.language,
...
impl From<String> for Option<url::Url> {
...
impl From<Option<url::Url>> for String {
    fn from(item: Option<url::Url>) -> Self {
        if let Some(i) = item {
            i.to_string()
        } else {
            String::new()
