...
impl Zoom {
    ...
    /// Create a building.
    pub async fn create_building(&self, mut building: Building) -> Result<Building, APIError> {
    ...
    /// Update a building.
    pub async fn update_building(&self, mut building: Building) -> Result<(), APIError> {
